...
UNIT
  ...
  mac)
    ...
    AGENT_27B_MAX_CONTEXT="${SLOPGATE_AGENT_27B_MAX_CONTEXT:-131072}"
    AGENT_27B_MODEL_ALIAS="${SLOPGATE_AGENT_27B_MODEL_ALIAS:-qwen27b}"
    AGENT_27B_NAME="${SLOPGATE_AGENT_27B_NAME:-leader-27b}"
    AGENT_27B_CANONICAL_MODEL="${SLOPGATE_AGENT_27B_CANONICAL_MODEL:-unsloth/qwen3.6:27b@128k}"
    AGENT_27B_MODEL_ALIASES="${SLOPGATE_AGENT_27B_MODEL_ALIASES:-qwen3.6-27b,qwen3.6-27b@128k}"
    AGENT_27B_QUANT="${SLOPGATE_AGENT_27B_QUANT:-Q4_K_M-MTP}"
    AGENT_122B_ADDR="${SLOPGATE_AGENT_122B_ADDR:-127.0.0.1:8083}"
    AGENT_122B_MAX_CONTEXT="${SLOPGATE_AGENT_122B_MAX_CONTEXT:-131072}"
